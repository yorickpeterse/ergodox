...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,           KC_TRANSPARENT,                                 KC_RALT,        MO(1),          KC_M,           KC_H,           KC_TRANSPARENT, KC_UP,          KC_TRANSPARENT,
    KC_F17,         KC_F18,         KC_F19,         KC_F20,         KC_LALT,                                                                                                        KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_RIGHT,
                                                                                    ...
                                                                                    KC_SPACE,       KC_TRANSPARENT, KC_AUDIO_VOL_DOWN,KC_PGDOWN,      OSL(2),         KC_ENTER
  ),
